...
/* harmony import */ var _modules_formModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/formModal */ "./src/js/modules/formModal.js");
/* harmony import */ var _modules_swiped_events_min__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/swiped-events.min */ "./src/js/modules/swiped-events.min.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_maskForm__WEBPACK_IMPORTED_MODULE_9__["default"])('[name="phone"]');
  Object(_modules_chechTextInput__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="userName"]', 50);
  Object(_modules_chechTextInput__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="email"]', 256);
  Object(_modules_chechTextInput__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="userText"]', 220);
});

/***/ }),

/***/ "./src/js/modules/chechTextInput.js":
/*!******************************************!*\
  !*** ./src/js/modules/chechTextInput.js ***!
  \******************************************/
...
var chechTextInput = function chechTextInput(selector, lenghtText) {
  var input = document.querySelector(selector);
  fCurPosEnd(input, lenghtText);

  function fCurPosEnd(elem, len) {
    elem.addEventListener('keypress', function (e) {
      var el = elem.value;
      var idd = 0;

      if (elem.value.length > lenghtText) {
        e.preventDefault();
      } else {
        ++idd;
      } // console.log(idd);
    ...
    elem.addEventListener('input', function (e) {
      ...
      if (elem.value.length > lenghtText) {
        // e.preventDefault();
        elem.value = elem.value.slice(0, lenghtText);
      } else {
        ++idd;
      } // console.log( elem.value.slice(0, 3));
      // console.log(idd);
      // console.log(len);
    ...
    // // elem.value = '+7(' + sNumb[1] + ')'+'-' + sNumb[2] + '-' + sNumb[3] + '-' + sNumb[4];
    // elem.focus();
    // elem.selectionStart = elem.selectionEnd = (elem.value.search(/[)-]*_/gi) < 0) ?
    //   elem.value.length :
    //   elem.value.search(/[)-]*_/gi);
  }
};

/* harmony default export */ __webpack_exports__["default"] = (chechTextInput);
...
/* harmony import */ var _services_modalservis__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/modalservis */ "./src/js/services/modalservis.js");
...
var form = function form() {
  ...
  }; // spere toggel on/off gateway


  var url = 'https://jsonplaceholder.typicode.com/posts';
  btnTogg.addEventListener('click', function () {
    if (!btnTogg.classList.contains('active')) {
      btnTogg.classList.add('active');
      return url = 'https:// jsonplaceholder.typicode.com/posts';
    } else {
      btnTogg.classList.remove('active');
      return url = 'https://jsonplaceholder.typicode.com/posts';
    }
  });
    ...
    if (userName.length <= 0 || userName.length >= 51 || email.length <= 0 || email.length >= 257) {
      ...
      if (userName.length <= 0 || userName.length >= 51) {
        ...
        if (htmlAttreb.getAttribute('lang') == 'en') {
          ...
          crateMasssegeNoValedText('name="userName"', 'Допустимая длина от 1 до 50', 'art');
        }
      }

      if (email.length <= 0 || email.length >= 257) {
        if (htmlAttreb.getAttribute('lang') == 'en') {
          crateMasssegeNoValedText('name="email"', 'Acceptable length from 1 to 256', 'eart');
        } else if (htmlAttreb.getAttribute('lang') == 'ru') {
          crateMasssegeNoValedText('name="email"', 'Допустимая длина от 1 до 256', 'eart');
        }
      }
    } else {
      //user entered corrected
      Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["clousModal"])(false, 400); //2 operating modes

      Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["createElement"])(); // add spiner пиздец
        ...
        try {
          ...
          if (i) {
            ...
            setTimeout(function () {
              ...
              Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["deleteElement"])('.data-svg-badSer', 2200);
              remove(2500);
              Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["errorSeeUserIMG"])();
              setTimeout(function () {
      ...
      postData(url, value).then(function (response) {
        ...
        setTimeout(function () {
          Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["deleteElement"])('.data-atribut', 10); //delete spiner

          Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["createGoodeSer"])(); // add галочку :)

          Object(_services_modalservis__WEBPACK_IMPORTED_MODULE_11__["deleteElement"])('.data-svg', 2000); //delete галочку
  ...
  function remove() {
    var timeout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1300;
    setTimeout(function () {
  ...
  function crateMasssegeNoValedText(nameInput, text, atribut) {
    ...
    btns.forEach(function (btn) {
      btn.addEventListener('click', function () {
        try {
          var NevCreate = document.querySelector(".data-bad-".concat(atribut));
          NevCreate.remove();
        } catch (error) {}
      });
    ...
    if (NevCreateElem) {
      ...
      _element.style.cssText = "zIndex=33; color: red; position: relative; top: -22px;";
      _element.innerText = "".concat(text);
      mssege.after(_element);
    }
  }
};
...
var formModal = function formModal() {
  var modal = document.querySelector('.modals_forms'),
      modalForm = document.querySelector('.modals_form'),
      btn = document.querySelector('#bottenOpenForm'),
      btnCloouse = document.querySelector('.clouse__slide_form'),
      btnMobilClous = document.querySelector('.mobile-close');
  btn.addEventListener('click', function () {
    openModal();
  }); // clouse modal
  ...
  btnMobilClous.addEventListener('click', function () {
    clousModal();
  });
  btnCloouse.addEventListener('click', function () {
    clousModalNau();
  });
  btnMobilClous.addEventListener('swiped-down', function (e) {
    clousModal();
  });

  function clousModalNau() {
...
var maskFormNumber = function maskFormNumber(selecter) {
...
/* harmony default export */ __webpack_exports__["default"] = (maskFormNumber);
  ...
  elem.forEach(function (item, i) {
    document.addEventListener('scroll', function () {
      ...
      itemMenu.forEach(function (e) {
        ...
        if (heightTop >= 2401 && heightTop <= 3050) {
          removeActev();
...
/***/ "./src/js/modules/swiped-events.min.js":
/*!*********************************************!*\
  !*** ./src/js/modules/swiped-events.min.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (swipere);
...
var trainslet = function trainslet() {
  var itext = __webpack_require__(/*! ../services/db.json */ "./src/js/services/db.json"),
      btns = document.querySelectorAll('#langvich');

  var enBtn = document.querySelector('#spanEUG'),
      enBtnMini = document.querySelector('#spanEumini'),
  ...
  function sovmet() {
    ...
    for (var key in itext.styles[index]) {
      for (var i = 0; i < 24; i++) {
        var element = document.querySelector("[data-translete=\"".concat(i, "\"]"));

        if (i == key) {
          element.innerHTML = itext.styles[index][key];
        }
      }
    }
    ...
    if (index == 0) {
      arr = ['Имя *', 'Телефон', 'Email *', 'Сообщение'];
    } else {
      arr = ['Name *', 'Phone', 'Email *', 'your message'];
    }

    for (var _i = 0; _i < 4; _i++) {
      var elemAttr = document.querySelector("[data-form=\"".concat(_i, "\"]"));
      elemAttr.setAttribute('placeholder', arr[_i]);
    }
    ...
    if (index == 0 || htmlAttreb == 'ru') {
      toggalVisualName(enBtn, enBtnMini, ruBtn, ruBtnMini);
      ruBtn.classList.add('languichActive');
      ruBtnMini.classList.add('languichActiveMini');
    } else if (index == 1 || htmlAttreb == 'en') {
      toggalVisualName(enBtn, enBtnMini, ruBtn, ruBtnMini);
      enBtn.classList.add('languichActive');
      enBtnMini.classList.add('languichActiveMini');
    } else {
      toggalVisualName(enBtn, enBtnMini, ruBtn, ruBtnMini);
      enBtn.classList.add('languichActive');
      enBtnMini.classList.add('languichActiveMini');
  ...
  function toggalVisualName(en, enMini, ru, ruMini) {
    en.classList.remove('languichActive', 'languichPassive');
    enMini.classList.remove('languichActiveMini', 'languichPassivemini');
    ru.classList.remove('languichActive', 'languichPassive');
    ruMini.classList.remove('languichActiveMini', 'languichPassivemini');
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clousModal", function() { return clousModal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openModal", function() { return openModal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createElement", function() { return createElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createGoodeSer", function() { return createGoodeSer; });
...
function clousModal() {
  var standart = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 520;
  var modal = document.querySelector('.modals_forms'),
      modalForm = document.querySelector('.modals_form');
  ...
  if (standart) {
    ...
    modalForm.classList.remove('visible');
    setTimeout(function () {
      modalForm.classList.remove('showModal');
      modalForm.classList.add('hideModal');
    }, time);
  }
}
...
function openModal() {
  ...
  if (standart) {
    ...
    modalForm.classList.add('showModal');
    modalForm.classList.remove('hideModal');
    document.body.style.overflow = 'hidden';
    setTimeout(function () {
      modalForm.classList.add('visible');
    }, time);
...
function createElement() {
  var select = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.modals_forms';
  var ower = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  var element = document.createElement('div');
  element.classList.add('data-atribut');
...
function errorSeeUserIMG() {
  var htmlAtt = document.querySelector('html').getAttribute('lang');
  var languichUser;
  console.log(htmlAtt);

  if (htmlAtt == 'en') {
    languichUser = 'Something went wrong... Contact me on social networks!';
    console.log(languichUser);
  } else if (htmlAtt == 'ru') {
    languichUser = 'Что-то пошло не так... Свяжитесь со мной в соц сетях!';
    console.log(languichUser);
  }
...
function deleteElement(select, timeout) {
  var owerf = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  setTimeout(function () {
    var i = document.querySelectorAll(select);
